...
export default function SavedScreen() {
      ...
      >
        <View className="flex-row justify-start w-[100%]shadow-sm">
          ...
          <View className="w-[70%] pl-4 justify-center space-y-1">
            {/* Author */}
            <Text className="text-xs font-bold text-gray-900 dark:text-neutral-300" style={{
                fontSize: hp(1.8),
            ...
            {/* Date */}
            <Text className="text-xs text-gray-700 dark:text-neutral-300" style={{
                fontSize: hp(1.5),
                fontFamily: "FranklinGothic",
              }}>
          ...
          <View className="w-[10%] justify-center">
            ...
            >
              <BookmarkSquareIcon color="black" />
            </TouchableOpacity>
          </View>
        </View>
      </TouchableOpacity>
  ...
  return (
    <SafeAreaView className="p-4 flex-1 dark:bg-neutral-900" style={{backgroundColor:'#F2F7BD'}}>
